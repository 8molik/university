...
;warto wprowadzić dodatkowy język bez cond, bo cond to tylko
;lukier syntaktyczny, więc równie dobrze mogłoby go nie być
...
(define (eval [e : Exp]) : Value
  ...
  ) ;konwersja cond na listę if'ów i ewaluacja dopiero wtedy ewaluacja
